                    ...
                    <div class="blog-details-desc">
                        ...
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    <li><i data-feather="clock"></i> <a href="#">September 31, 2021</a></li>
                                    <li><i data-feather="user"></i> <a href="#">Steven Smith</a></li>
                                </ul>
                            </div>
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <article class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="assets/img/client-image/2.jpg" class="avatar"
                                                            alt="image">
                                        ...
                                        <ol class="children">
                                            <li class="comment">
                                                <article class="comment-body">
                                                    <footer class="comment-meta">
                                                        <div class="comment-author vcard">
                                                            <img src="assets/img/client-image/3.jpg" class="avatar"
                                                                alt="image">
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <article class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="assets/img/client-image/5.jpg" class="avatar"
                                                            alt="image">
